...
8.Discuss the concept of "forking" a repository on GitHub. How does forking differ from cloning, and what are some scenarios where forking would be particularly useful?
  ...
  Difference between Forking and Cloning
          ...
          -Forking, on the other hand, creates a new repository on GitHub that is based on the original repository. Changes made to the forked repository are not automatically synced 
               back to the original repository.

  Scenarios Where Forking is Useful
          -Collaborating on projects: Forks allow multiple developers to work on different branches of a project without affecting the main repository. Contributors can create pull      
              requests to merge their changes back to the original repository.
